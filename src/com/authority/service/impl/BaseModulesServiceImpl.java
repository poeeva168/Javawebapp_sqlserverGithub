...
import com.authority.dao.BaseModulesMapper;
import com.authority.dao.BaseRoleModuleMapper;
import com.authority.pojo.BaseModules;
import com.authority.pojo.BaseRoleModule;
import com.authority.pojo.BaseUsers;
import com.authority.pojo.Criteria;
import com.authority.pojo.Tree;
import com.authority.pojo.TreeMenu;
...
public class BaseModulesServiceImpl implements BaseModulesService {
	...
	public Tree selectModulesByUser(BaseUsers baseUser) {
		...
		// 显示所有模块  管理员
		if (resoved&&baseUser.getAccount().equals("admin")) {
			example.setOrderByClause(" DISPLAY_INDEX ASC");
