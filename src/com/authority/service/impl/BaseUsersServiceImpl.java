...
import com.authority.dao.BaseUsersMapper;
...
public class BaseUsersServiceImpl implements BaseUsersService {
	...
	@Value("${email.host:mail.nit.net.cn}")
	private String emailHost;
	@Value("${email.account:cf@nit.net.cn}")
	private String emailAccount;
	@Value("${email.password:314159}")
	private String emailPassword;
	@Value("${system.url:http://localhost:8080/}")
	...
	public String findPassword(Criteria example) throws Exception {
		...
		String title="HELLO: "+dataBaseUser.getAccount()+"，请重新设置你的帐户密码！";
