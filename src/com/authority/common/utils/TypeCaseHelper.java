...
public class TypeCaseHelper {
	...
	public static Object convert(Object obj, String type, String format) throws TypeCastException {
		...
		if("Map".equals(type) || "java.util.Map".equals(type)){
			...
			//	System.out.println("fieldType:"+fieldType);
				...
				//	System.out.println("method_temp.getName():"+method_temp.getName()+"  getMethodName:"+getMethodName);
					if(!method_temp.getName().equals(getMethodName));
					else {						
						Method getMethod;   
						try {    
	...
	public static Map<String,Object> convert2Map(Object obj) throws TypeCastException{
		return (Map<String,Object>) convert(obj, "Map", null);
	}
}
